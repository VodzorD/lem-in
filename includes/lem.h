...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/20 22:31:07 by wscallop          #+#    #+#             */
/*   Updated: 2020/12/01 18:46:51 by wscallop         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**		steps - шаги, которые делают муравьи
...
**		matrix - массив соединений комнат
...
**				(комнат)
**
**		Структура практически полностью повторяет t_lst (см. выше)
**
**		rs - флаг, показывающий что в t_lst 'r' и 's' отмечены
**		re - флаг, показывающий что в t_lst 'r' и 'e' отмечены
**
**		Структура используется для валидации (см. файл valid.c)
*/
